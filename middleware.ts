...
export async function middleware(request: NextRequest) {
  ...
  const publicApiPaths = ['/api/auth/signup', '/api/auth/set-cookie', '/api/auth/sync-user', '/api/settings/signup-status', '/api/changelog/public'];
...
export const config = {
  matcher: [
    '/((?!api|_next/static|_next/image|favicon.ico|logo.png|logo-cool.png|media).*)',
    '/api/:path*',
  ],
};